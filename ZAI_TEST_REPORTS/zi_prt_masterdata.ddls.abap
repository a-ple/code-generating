...
define view entity ZI_PRT_MASTERDATA as select from crfh {
  ...
  key zaehl       as CountValue,
      ...
      aenam       as ChangeName,
      aedat       as ChangeDate,
      brgru       as FunctionalArea,
      status      as Status,
      kzkbl       as IndicatorKzkbl,
      stowk       as Plant,
      stort       as StorageLocation,
      baseh       as BaseUnit,
      steuf       as SpecialStockIndicator,
      steuf_ref   as SpecialStockReference,
      fgru1       as FunctionalArea1,
      fgru2       as FunctionalArea2,
      planv       as PlanningVersion,
      ktsch       as SchedulingType,
      ktsch_ref   as SchedulingTypeReference,
      bzoffb      as OffsetWritingOff,
      bzoffb_ref  as OffsetWritingOffReference,
      offstb      as OffsetUnit,
      ehoffb      as OffsetUnitReference,
      offstb_ref  as OffsetUnitRef,
      bzoffe      as Bzoffe,
      bzoffe_ref  as BzoffeRef,
      offste      as Offste,
      ehoffe      as Ehoffe,
      offste_ref  as OffsteRef,
      mgform      as Mgform,
      mgform_ref  as MgformRef,
      ewform      as Ewform,
      ewform_ref  as EwformRef,
