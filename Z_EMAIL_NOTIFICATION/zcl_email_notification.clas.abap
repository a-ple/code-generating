CLASS zcl_email_notification DEFINITION PUBLIC FINAL CREATE PUBLIC.
  PUBLIC SECTION.
    " Sends email with optional Excel (.xlsx) attachments using SAP BCS classes
    METHODS send_email
      IMPORTING
        iv_email_body        TYPE string
        it_attachment_files  TYPE STANDARD TABLE OF solix OPTIONAL
...
CLASS zcl_email_notification IMPLEMENTATION.
  METHOD send_email.
    ...
    " For testing, use constant recipient if none supplied
