...
@EndUserText.label: 'Composite Email Notification View'
@VDM.viewType: #COMPOSITE
@Analytics.dataCategory: #CUBE

define view Z_I_EMAIL_NOTIFICATION as select from I_SalesOrderHeader as SalesOrder
  inner join I_SalesOrderItem as SalesOrderItem on SalesOrder.SalesOrder = SalesOrderItem.SalesOrder
  left outer join I_Material as Material on SalesOrderItem.Material = Material.Material
  left outer join I_PurchaseOrderItem as PurchaseOrderItem on SalesOrder.PurchaseOrder = PurchaseOrderItem.PurchaseOrder
{
